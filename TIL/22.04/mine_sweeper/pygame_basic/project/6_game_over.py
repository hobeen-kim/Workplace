...
ball_images = [balloon1, balloon2, balloon3, balloon4]
...
balls.append({
    ...
    "to_x" : 3, #공의 x축 이동방향, -3이면 왼쪽, 3이면 오른쪽으로
    "to_y" : -6, # y축 이동방향,
...
while running:
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        ### 그 외의 모든 경우에는 속도를 증진적으로 변경 (포물선 효과)
        else:
            ball_val["to_y"] += 0.5
        ...
        for weapon_idx, weapon_val in enumerate(weapons):
           ...
           ### weapon rect 정보 업데이트
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                ### 공 나누기 (가장 작은 크기의 공이 아니라면 다음 단계의 공으로 나눠주기)
                if ball_img_idx < 3:
            ...
            continue # 안쪽 for 문 조건이 맞지 않으면 continuew
